class Bryan extends ObjetEnnemi{
  ...
  */
  constructor(scene, x, y) {
    ...
    this.anims.create({
      key: 'move',
      frames: this.anims.generateFrameNumbers('bryan', { start: 9, end: 15 }),
      frameRate: 7,
      repeat: -1,
    });
    this.anims.create({
      key: 'stand',
      frames: this.anims.generateFrameNumbers('bryan', { start: 0, end: 8 }),
      frameRate: 7,
      repeat: -1
    ...
    this.anims.create({
      key: 'die',
      frames: this.anims.generateFrameNumbers('bryan', { start: 16, end: 19 }),
      frameRate: 10,
    });
